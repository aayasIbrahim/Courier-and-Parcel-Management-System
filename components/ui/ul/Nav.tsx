...
function Nav() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 backdrop-blur-md  bg-base-100 shadow-lg transition-transform duration-300 ${
    ...
    >
      <div className="container mx-auto navbar shadow-sm">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">Courier Pro</a>
        </div>
